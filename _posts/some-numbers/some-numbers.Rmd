...
```{r n words char, fig.cap="Number of words per character.", fig.height=6}
text %>% 
  count(speaker) %>% 
...
```{r char by genre, fig.cap="Number of words per character and genre.", layout = "l-outset", fig.height=6}
topspeakers <- text %>% 
...
```{r mixing by act, fig.height=7, fig.width=11, layout="l-screen-inset shaded"}
pal = wes_palette("BottleRocket2")[1:5]
text %>% 
  ...
  labs(title = "Characters Mixing Genres Across Acts",
       subtitle = "Showing only the ones who mix",
       caption = "The Taming of the Shrew",
       x = "Act",
       y = "Number of words") +
  theme_classic(base_family = "Arial Narrow")
