...
text %>% 
  ...
  pull(word)
```
It's not too terrible. Well -- *thee, thy* etc. should have been removed as stopwords; *stocks, rogues* and *denier* should have been counted as negative, and *Saint* as positive -- but it's alright. We can apply the method and trust it will tell us something informative Here, then, is the top of the list of words that were sentiment-tagged.

<aside>I'm not aware of a Renaissance stopword list or sentiment dictionary, but it's something that a digital Shakespeare scholar should create on a grant project.</aside>
