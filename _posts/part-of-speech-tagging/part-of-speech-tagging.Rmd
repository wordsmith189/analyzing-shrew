...
```{r fig.cap="Frequency of tags in index groups as ratio between n and v.", layout="l-outset"}
...
```{r fig.cap="Frequency of tags in n/v index groups, by genre.", layout="l-outset", fig.width=9, fig.height=10}
